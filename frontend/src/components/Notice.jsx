      ...
      {open && (
        <form className="mt-8 w-full">
          <div className="w-[40%] mt-2">
            <label htmlFor="title">Nội dung Hoạt Động*</label>
            <input
              type="text"
              id="title"
          ...
          <div className="w-[40%] mt-4">
            <label htmlFor="title">Chi tiết Hoạt Động*</label>
            <textarea
              id="title"
              cols="30"
              rows="4"
          ...
          <div className="w-[40%] mt-4">
            <label htmlFor="link">Link Đăng kí Hoạt Động (Nếu có)</label>
            <input
              type="text"
              id="link"
              value={data.link}
